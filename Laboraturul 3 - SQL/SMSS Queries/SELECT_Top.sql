...
--SELECT TOP is generally used to SELECT data entries from tables that have thousands upon thousands of entries.
--It can be used to select the n-th top elements or the top nth percent entries in a table

SELECT TOP 3 * FROM shipyard;

SELECT TOP 50 PERCENT * FROM shipyard;