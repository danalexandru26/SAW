...
SELECT * FROM shipyard WHERE shipClass = 'destroyer' OR shipClass = 'cruiser';

--AND and OR combinations

SELECT * FROM shipyard WHERE (shipType = 'civilian' AND shipClass = 'passenger') OR (shipType = 'military' AND shipClass = 'frigate');