...
--DELETE removes data entries. Similarily to the UPDATE statement, if WHERE is omitted all entries will be removed.
...
DELETE FROM shipyard WHERE shipType = 'civilian';
