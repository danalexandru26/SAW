...
--In order to showcase the new value, we have to insert a data entry that actually has a null field.
--Our data schema allows null data fields for data attributes that have deemed not crucial. cargoCapacity is one.

INSERT INTO shipyard VALUES('ISS Andromeda', 'civilian', 'passenger', 2500, 1200, NULL, 90000, 80, 0, 75.0, 3, 100, 50000, 3);

SELECT * FROM shipyard WHERE cargoCapacity is NOT NULL;
